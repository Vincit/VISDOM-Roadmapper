...
export const RoadmapGraphPage = () => {
  ...
  const dimensions = ({
    ...
    width: complexity,
    height: hasReadCustomerValuesPermission ? weightedTotalValue : totalValue,
  });
