export const english = {
  translation: {
    ...
    'Rated tasks': 'Rated tasks',
    'Task title': 'Task title',
    'Current average value': 'Current average value',
    'Current complexity': 'Current complexity',
    ...
    'Task map info':
      '<strong>Managing task relations.</strong> Roadmapper provides two options for adding task relations: you can either add them separately for each task in Task details page or collectively through the graphic view, the task map.',
    'How to use the task map': 'How to use the task map',
    Overview: 'Overview',
    Actions: 'Actions',
    'Task map actions description':
      'Start by drag and droping tasks from Unstaged tasks list into the task map area. Task map has the following mouse actions:',
    'Got it': 'Got it!',
    Relations: 'Relations',
    'Relations description': 'Tasks connected by a line',
    Synergies: 'Synergies',
    'Synergies description': 'Tasks in a same group (light blue box)',
    View: 'View',
    'Task map': 'Task map',
    'Task map description': 'Includes tasks with relations and synergies',
    'Task circles': 'Task circles',
    'Task circles description': 'Connect task to other tasks on the map',
    'Unstaged tasks list': 'Unstaged tasks list',
    'Unstaged tasks list description':
      'Holds tasks without relations or synergies',
    'Task info': 'Task info',
    'Task info description': 'Shows selected task’s info below the task map',
    'Screen functions': 'Screen functions',
    'Fit groups into the viewport': 'Fit groups into the viewport',
    'Fit groups description': 'Shows the center of the map',
    'Reset group positions': 'Reset group positions',
    'Reset group positions description':
      'Removes saved group positions and generates a new layout',
    'Adding and removing task relations & Synergies':
      'Adding and removing task relations & Synergies',
    'Add relation': 'Add relation',
    'Add relation action':
      'Left-click on a task circle to show possible connections and hold left-click to drag a line',
    'Add relation description':
      'to another task circle. (Orange creates dependencies, green creates prerequisites)',
    'Remove relation action': 'Left or right click on the line',
    'Remove relation description': 'to open a context menu.',
    'Add synergy': 'Add synergy',
    'Add synergy action': 'Drag and drop a task into',
    'Add synergy description': 'another light blue area.',
    'Remove synergy': 'Remove synergy',
    'Remove synergy action': 'Drag an drop a task out of',
    'Remove synergy description': 'the light blue area.',
    'Reorganizing the view and viewing info':
      'Reorganizing the view and viewing info',
    'Move a task or group': 'Move a task or group',
    'Move a task or group action': 'Hold left-click on a task or group',
    'Move a task or group description': 'to move it around the map.',
    'Show task info': 'Show task info',
    'Show task info action': 'Left-click on a task',
    'Show task info description': 'to open task info.',
    'Click or Click & drag': 'Click or Click & drag',
